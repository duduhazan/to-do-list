...
export function deleteTask(id) {
    return fetch('http://localhost:5000/' + id, {method: "delete"});
}

export function deleteAll() {
    return fetch('http://localhost:5000/delete/all', {method: "delete"});
}
...
export function getTaskByID(id) {
    return fetch('http://localhost:5000/' + id).then((res) => res.json());
}
